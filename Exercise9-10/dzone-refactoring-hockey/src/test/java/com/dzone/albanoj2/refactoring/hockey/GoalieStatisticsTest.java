...
public class GoalieStatisticsTest {
	...
	@Test
	public void onePartialGameInSeasonEnsureCorrectSavePercentage_Excersise9_10() {
		season.addGame(new Game(4, 16, 30 ));
		GoalieStatistics statistics = season.getGoalieStatistics();
		assertEquals(0.75, statistics.getSavePercentage(), TOLERANCE);
	}

	@Test
	public void threeGameInSeasonEnsureCorrectSavePercentage_Excersise9_10() {
		season.addGame(new Game(4, 17, 60 ));
		season.addGame(new Game(8, 24, 60 ));
		season.addGame(new Game(2, 20, 60 ));
		GoalieStatistics statistics = season.getGoalieStatistics();
		assertEquals(0.7705, round4Decimals(statistics.getSavePercentage()), TOLERANCE);
	}
}
